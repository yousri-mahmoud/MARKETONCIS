      ...
      <div className="about__content gap">
        <div className="about__content__about">
          ...
          <p className="w-75 m-auto">
            ...
            graduation project for us, and we hope this website will be a screen
            for our skills
          </p>
        </div>
          ...
          <div className="row  justify-content-center">
            <div className="about__content__team__box col-lg-3">
              ...
              <div className="about__content__team__box__info">
                ...
                <a
                  target="blank"
                  href="https://www.linkedin.com/in/yousri-mahmoud-6ab298214/"
                >
            ...
            <div className="about__content__team__box col-lg-3">
              ...
              <div className="about__content__team__box__info">
                ...
                <a
                  target="blank"
                  href="https://www.linkedin.com/in/saif-alaa-eldin/"
                >
                  <FaLinkedin className="about__content__team__box__info__icon" />
                </a>
              </div>
            ...
            <div className="about__content__team__box col-lg-3">
              ...
              <div className="about__content__team__box__info">
                ...
                <a
                  target="blank"
                  href="https://www.linkedin.com/in/saleh-farag/"
                >
                  <FaLinkedin className="about__content__team__box__info__icon" />
                </a>
              </div>
